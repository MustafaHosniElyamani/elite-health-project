...
<div class="container-fluid" style="background-color: #3fbbc0; padding: 20px; margin-top: 140px;">
    <h2 style="color: white; text-align: center;">بيانات المستشفى</h2>
    <form method="post" action="{{ route('client.hospital.store') }}">
        @csrf

        <div class="row">
            <div class="col-md-12 mb-3">
                <label for="name" class="form-label" style="color: white;">الاسم</label>
                <input type="text" class="form-control" id="name" name="name" style="background-color: white;">
            </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="password" class="form-control" id="password" name="password" style="background-color: white;">
            </div>
            <div class="col-md-6 mb-3">
      ...
      <div class="row"><label style="color: white;">التخصصات</label><br>
        <div class="col-md-12 mb-3 d-flex justify-content-between">

     
          <div>
            <label for="القلب">القلب والأوعية الدموية</label>
            <input type="checkbox" name="specialties[]" value="القلب" id="cardiology">
          </div>
          <div>
            <label for="العصبي">الجهاز العصبي</label>
            <input type="checkbox" name="specialties[]" value="العصبية" id="neurology">
          </div>
          <div>
            <label for="الجلدية">الجلدية</label>
            <input type="checkbox" name="specialties[]" value="الجلدية" id="dermatology">
          </div>

          <div>
            <label for="الاطفال">طب الأطفال</label>
            <input type="checkbox" name="specialties[]" value="الاطفال" id="pediatrics">
          </div>
