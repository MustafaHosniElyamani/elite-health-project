...
<div class="row">
    <div class="col-lg-10 mx-auto mb-1">
        <div class="section-title text-center ">
            <h1 class="top-c-sep" style="color: #3fbbc0;">قائمة المستشفيات</h3>
...
<div class="row">
    <div class="col-lg-10 mx-auto">
        <div class="career-search mb-60">
            <form action="" methos="get" class="career-form mb-60">
                @csrf
                <div class="row">
                    <div class="col-md-6 col-lg-3 my-3">
                        <div class="input-group position-relative">
                            <input type="text" name="name" class="form-control" placeholder="ابحث باسم المستشفى"
                                id="keywords">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3 my-3">
                                      ...
                                      <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                                          <div class="job-left my-4 d-md-flex align-items-center ">
                                            <div class="img-holder mr-md-4 mb-md-0 mb-4 mx-auto mx-md-0 d-md-none d-lg-flex">
                                                <span style="font-size: medium;">مستشفى</span>
                                            </div>
                                                  ...
                                                  <div class="modal-content">
                                                      <div class="modal-header">
                                                          <h1 class="modal-title fs-5" id="exampleModalLabel"
                                                              style="color: #3fbbc0; margin-left: 70%;">معلومات المستشفى</h1>
                                                          <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                              aria-label="Close"></button>
                                                      </div>
                                                      <div class="modal-body">
                                                     <h3>التخصصات: {{$record->specialties}}</h3>
