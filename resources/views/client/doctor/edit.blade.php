...
@section('content')
    <div class="container-fluid" style="background-color: #3fbbc0; padding: 20px; margin-top: 140px;">
        <h2 style="color: white; text-align: center;">تعديل بيانات الطبيب </h2>
        <form action="{{ route('client.doctor.update')  }}" method='post'>
            @csrf
            @method('put')
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="specialty" style="background-color: white;">
