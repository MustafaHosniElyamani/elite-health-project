...
<div class="container-fluid  " style="background-color: #3fbbc0; padding: 20px;  margin-top:140px; ">
    <h2 style="color: white; text-align: center;">بيانات المريض </h2>
    <form method="post" action="{{ route('client.patient.store') }}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" name="age" style="background-color: white;">
            </div>
        </div>
            ...
            <div class="col-md-6 mb-3">
                  ...
                  <div class="col-md-3 mb-3">
                    ...
                    <div class="form-check">
                      <input class="form-check-input form-radio-input" type="radio" name="gender" value="male" id="male">
                      <label class="form-check-label form-radio-label" for="male">ذكر</label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input form-radio-input" type="radio" name="gender" value="female" id="female">
